...
const isLastExpression = ({ sequence, expression }) => last(sequence.expressions) === expression;
...
const createNoExpression = (context) => {
    ...
    return {
        AssignmentExpression: createVisitor("Assignments are only allowed as statements or voided expressions."),
        UpdateExpression: createVisitor("Updates are only allowed as statements or voided expressions."),
    };
};
exports.default = {
    meta: {
